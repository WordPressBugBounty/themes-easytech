...
EasyTech is a lightweight, stunning, professional and flexible WordPress Theme. EasyTech is perfect for Startup, IT Solutions, IT Business, Agencies, Marketing, Consulting and Services Company related to any business websites. EasyTech based on in-depth research into IT Solutions, IT Services, IT Business, Consulting & Software, Digital Solution, Technical Engineering, Technology, and Services Company, to deliver all needed layouts and blocks. It will enable you to create almost any type of website with a beautiful & professional design. EasyTech Pro demo https://preview.desertthemes.com/pro/easytech/


== Installation ==
	
1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in EasyTech in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.


== Copyright ==

EasyTech WordPress Theme, Copyright 2023 , Desert Themes
EasyTech is distributed under the terms of the GNU GPL

SoftMe WordPress Theme, Desert Themes. SoftMe WordPress Theme is distributed under the terms of the GNU GPL
...
* Screenshot Banner Image - https://pxhere.com/en/photo/872707
...
@version 1.1.32
* Tested - By WordPress 7.1.1

@version 1.1.31
* Style improvements - Block Accordion
...
@version 1.1.28
* Tested - By WordPress 7.1

@version 1.1.27
* Tested - By WordPress 7.0.4

@version 1.1.26
* Tested - By WordPress 7.0.3 

@version 1.1.25
* Style improvements - Block Search   

@version 1.1.24
* Style improvements - Block List  

@version 1.1.23
* Tested - By WordPress 7.0.2  

@version 1.1.22
* Style improvements - Product Title 

@version 1.1.21
* Style improvements - Widget Product List

@version 1.1.20
* Style improvements - Block Customer Account

@version 1.1.19
* Tested - By WordPress 7.0

@version 1.1.18
* Style improvements - Block Woocommerce Customer Account

@version 1.1.17
* Style improvements - Block Woocommerce Customer Account

@version 1.1.16
* Style improvements - Cart Page
...
@version 1.1.13
* Style improvements - Product Meta

@version 1.1.12
* Tested - By WordPress 6.9.4

@version 1.1.11
* Tested - By WordPress 6.9.3

@version 1.1.10
* Style improvements - Block File

@version 1.1.9
* Style improvements - Block File

@version 1.1.8
* Style improvements - Block Comment

@version 1.1.7
* Tested - By WordPress 6.9.1
...
@version 1.0.70
* Tested - By WordPress 6.8.1

@version 1.0.69
* Style improvements - Block Page List

@version 1.0.68
* Tested - By WordPress 6.8
...
@version 1.0.64
* Style improvements - Block Comment Date
...
@version 1.0.61
* Style improvements - WooCommerce Cart Page Remove

@version 1.0.60
* Style improvements - WooCommerce Cart Page Coupon

@version 1.0.59
* Tested - By WordPress 6.7.2

@version 1.0.58
* Style improvements - WooCommerce Block Cart Badge
...
@version 1.0.55
* Style improvements - WooCommerce Block Cart Description

@version 1.0.54
* Style improvements - WooCommerce Block Cart Total Label

@version 1.0.53
* Style improvements - WooCommerce Block Cart Button

@version 1.0.52
* Style improvements - WooCommerce Block Cart Title
...
@version 1.0.24
* Tested - By WordPress 6.5.4

@version 1.0.23
* Tested - By WordPress 6.5.3
...
@version 1.0.11
* Style improvements - Product Sale Badge
...
@version 0.2
* Fixed - Mobile Toggle Color Issue
