 ...
 */
final class EasyTech_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Softme_Customize_Section_Pro(
				...
				'softme',
				array(
                    'pro_text' => esc_html__( 'Upgrade to EasyTech Pro','easytech' ),
                    'pro_url'  => 'https://desertthemes.com/themes/easytech-pro/',
                    'priority' => 0
                )
			)
		);
...
EasyTech_Customize::get_instance();