...
<header id="dt_header" class="dt_header header--eight">
	<div class="dt_header-inner">
		<div class="dt_header-topbar dt-d-lg-block dt-d-none">
			<?php do_action('easytech_site_header'); ?>
		</div>
		<div class="dt_header-navwrapper">
			<div class="dt_header-navwrapperinner">
				<!--=== / Start: DT_Navbar / === -->
				<div class="dt_navbar dt-d-none dt-d-lg-block">
					<div class="dt_navbar-wrapper <?php if($softme_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','easytech'); endif; ?>">
				...
				<div class="dt_mobilenav <?php if($softme_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','easytech'); endif; ?> dt-d-lg-none">
